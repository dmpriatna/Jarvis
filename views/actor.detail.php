...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        ...
        <div class="col" style="margin-left: 60px; display: grid; align-items: center; align-content: space-evenly;">
            ...
            <h4 style="margin-top: -40px; font-weight: 500; color: var(--color-theme-0); font-size: 20px; font-family: Lora;">Freelancer across disciplines formulate the best way to help SME's, which we prove explicity!</h4>
            <p style="margin-top: -50px; color: var(--color-theme-0); font-size: 16px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse.</p>
            <span style="margin-top: -40px;">Teaching students all about the beste SEO techniques is something I love to do as a full-time job</span>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <h2>Data Science Project Proposal Presentation</h2>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="picture/portfolio-4.jpg" alt="">
        </div>
    </div>
</div>
<div class="container">
