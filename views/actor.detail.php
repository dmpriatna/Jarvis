...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        ...
        <div class="col" style="margin-left: 60px; display: grid; align-items: center; align-content: space-evenly;">
            ...
            <h4 style="padding-top: -16px; font-weight: 500; color: var(--color-theme-0); font-size: 20px; font-family: Lora;">Freelancer across disciplines formulate the best way to help SME's, which we prove explicity!</h4>
