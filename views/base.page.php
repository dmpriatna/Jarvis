                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-contact">
                            ...
                            <p style="left: 0; width: 50%; bottom: 0; border-bottom: solid 1px;  content: ''; padding-bottom: 10px; font-size: 14px;"><i class="fa fa-map-marker-alt"></i>Jl. Cigadung Raya Timur No. 35, Cigadung, Kec.
