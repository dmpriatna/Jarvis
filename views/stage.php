    ...
    <div class="container py-5">
        ...
        <div class="row py-5">
            <div class="col-md-6">
                ...
                <div class="f-21-b c-0" style="padding-top: 35px;">Parakarsa bersama pendamping lintas disiplin ilmu menciptakan produk dokumentasi terbaik.</div>
            ...
            <div class="col-lg-4 col-md-12 bc-1">
                <div class="">
                    <div class="feature-text">
                        ...
                        <br>
                        <p style="font-size: 14px; padding-top: 55px;">#TerusBerdampingan bersama Parakarsa</p>
                        <br>
                        <div class="btn invert">Join Now</div>
                    </div>
                </div>
