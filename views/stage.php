        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="/more" class="btn invert mt-3 py-2 px-4" style="font-size: 16px; font-family: Modeco Trial; height: 40px; background-color: var(--color-theme-1);color: var(--color-theme-2); text-align: center;">Lebih Banyak Project</a> 
                </div>
