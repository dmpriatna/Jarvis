...
<div class="container mt-50">
    ...
    <div class="row" style="text-align: center;">
        <div class="col-sm-4">
            <h1 class="mb-2" style="font-size: 60px; font-family: Lora; padding-bottom: 24px; padding-top: 60px;" data-toggle="counter-up">500</h1>
        ...
        <div class="col-sm-4">
            <h1 class="mb-2" style="font-size: 60px; font-family: Lora; padding-bottom: 24px; padding-top: 60px;" data-toggle="counter-up">50</h1>
        ...
        <div class="col-sm-4">
            <h1 class="mb-2" style="font-size: 60px; font-family: Lora; padding-bottom: 24px; padding-top: 60px;" data-toggle="counter-up">20</h1>
