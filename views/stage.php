        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="/more" class="btn invert mt-3 py-2 px-4" style="font-size: 16px; font-weight: regular; font-family: Modeco Trial; height: 40px; background-color: var(--color-theme-1);color: var(--color-theme-2); text-align: center;">Lebih Banyak Project</a> 
                </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="feature-item">
                    <div class="feature-text">
                        ...
                        <br>
                        <p style="font-size: 14px; padding-top: 25px;">#TerusBerdampingan bersama Parakarsa</p>
                        <br>
                ...
                <div class="feature-item">
                    <div class="feature-text">
                        <div class="d-flex"><img src="picture/papers.svg" alt="papers" style="margin-right: 10px; padding-bottom:20px;width:62px; height:62px;">
                            <h3 style="padding-top: 8px;"><b>Para</b>Beyond</h3>
                        </div>
...
<div class="team bc-2">
    <div class="container" >
        ...
        <div class="owl-carousel row team-carousel" style="padding-top: 20px;">
