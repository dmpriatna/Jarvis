    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <span class="c-1" style="margin: 50px 20px;">Menambahkan value lebih jadi ciri khas kami dalam mendampingi, anda bisa sekaligus berkolaborasi bersama partner kami setelahnya.</span>
            </div>
        </div>
        <div class="row py-5">
