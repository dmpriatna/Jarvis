    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <span class="c-1" style="font-size: 16px;">Pembukitian merupakan fokus kami agar UMKM bisa naik kelas, jadi metode Co-creation ini dapat kami pertanggung jawabkan kepada anda.</span>
            </div>
            <div class="col-md-3">
