        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <h1 class="animated fadeInRight v-line-6 c-2" style="font-size: 40px;">Raih Keuntungan dengan Pendampingan Co-creation</h1>
                    <p class="animated fadeInLeft" style="font-size: 16px; margin-right: 270px;">Pendampingan  Dokumentasi Lintas disiplin
                         ilmu untuk mengembangkan, memperbaiki, & Menumbuhkan Bisnis UMKM.</p>
                    <div style="display: flex; align-items: center;">
                        <a class="btn animated fadeInUp" href="/blank" style="font-size: 14px; margin-top: 30px; width: 250px; height: 55px;">Join Our Ecosystem</a>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    ...
                    <p class="animated fadeInLeft" style="font-size: 20px; margin-right: 200px;">Komunitas yang telah   Dokumentasi Lintas disiplin ilmu untuk UMKM, Freelancer, & Partner Parakarsa </p>
                    <div style="display: flex; align-items: center;">
    ...
    <div class="container py-5">
        ...
        <div class="row py-5">
            ...
            <div class="col-md-6">
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="/#" style="font-size: 20px; color: var(--color-theme-1); font-weight: bold;">Bisnis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/#" style="font-size: 20px; color: var(--color-theme-1);">Desain</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/#" style="font-size: 20px; color: var(--color-theme-1);">Marketing</a>
                    </li>
                </ul>
                <div class="line-1 c-3 bc-3" style="margin: 10px 0;"></div>
                <img src="picture/bisnis.png" alt="bisnis" width="100%" height="350px" style="margin-top: 40px;">
            </div>
        </div>
    </div>
    <!-- End -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-12">
                <div class="feature-item">
                    <div class="feature-text">
                        <div class="d-flex"><img src="picture/ribbon.svg" alt="ribbon" style="margin-right: 10px; width:72px; height:72px;">
                            <h3>ParaProven</h3>
                        </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="feature-item bc-3">
                    <div class="feature-text">
                        <div class="d-flex"><img src="picture/people.svg" alt="people" style="margin-right: 10px; width:72px; height:72px;">
                            <h3>ParaConnect</h3>
                        </div>
