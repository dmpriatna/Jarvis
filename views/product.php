    <!-- Website Title -->
    <title>Natar - Training Course</title>
    
    <!-- Styles -->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,400i,600,700,700i&display=swap" rel="stylesheet">
    <link href="views/CORSO/css/bootstrap.css" rel="stylesheet">
    <link href="views/CORSO/css/fontawesome-all.css" rel="stylesheet">
    <link href="views/CORSO/css/swiper.css" rel="stylesheet">
	<link href="views/CORSO/css/magnific-popup.css" rel="stylesheet">
	<link href="views/CORSO/css/styles.css" rel="stylesheet">
	
	<!-- Favicon  -->
    <link rel="icon" href="views/CORSO/images/favicon.png">
</head>
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <div class="swiper-container image-slider-1">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" >
                            <img class="img-fluid" src="views/CORSO/images/details-slide-1.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="views/CORSO/images/details-slide-2.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="views/CORSO/images/details-slide-3.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="slider-container">
                        <div class="swiper-container image-slider-2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-1.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-2.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-3.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-4.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-5.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                        <img class="img-fluid" src="views/CORSO/images/customer-logo-6.png" alt="alternative">
                                </div>
                            </div> <!-- end of swiper-wrapper -->
                        </div> <!-- end of swiper container -->
                    </div> <!-- end of slider-container -->
    ...
    <div id="instructor" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid" src="views/CORSO/images/instructor.jpg" alt="alternative">
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
    ...
    <div class="basic-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="views/CORSO/images/students.jpg" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of basic-3 -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="views/CORSO/images/details-lightbox.jpg" alt="alternative">
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="views/CORSO/images/video.jpg" alt="alternative">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="views/CORSO/images/testimonial-1.jpg" alt="alternative">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="views/CORSO/images/testimonial-2.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="views/CORSO/images/testimonial-3.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" src="views/CORSO/images/testimonial-4.jpg" alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
    ...
    <!-- Scripts -->
    <script src="views/CORSO/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="views/CORSO/js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="views/CORSO/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="views/CORSO/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="views/CORSO/js/jquery.countdown.min.js"></script> <!-- The Final Countdown plugin for jQuery -->
    <script src="views/CORSO/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="views/CORSO/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="views/CORSO/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="views/CORSO/js/scripts.js"></script> <!-- Custom scripts -->
</body>
</html>