        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-lg page-scroll" href="#register" style="font-family: Modeco;color: #FFFFFF; margin-top: 20px; padding-top: 10px; padding-bottom: 10px; border: 1px solid #FFFFFF;">REGISTER</a>
