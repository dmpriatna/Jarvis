...
<div class="container-fluid p-5 section-2">
    <div class="row">
        <div class="col-6">
            <img class="bottle1" style="margin-left: 80px;" src="picture/bottle.svg">
        </div>
        <div class="col-6">
            <div class="card">
                <div class="card-body">
...
<div id="contact" class="form-3" style="margin-top: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2 style="font-weight: bold; font-family: Modeco; color: var(--color-theme-3);">Contact Details</h2>
                        <p>For registration questions please get in touch using the contact details below. For any questions use the form.</p>
                        <h3 style="font-weight: bold; font-family: Modeco; color: var(--color-theme-3);">Main Office Location</h3>
