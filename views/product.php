<!-- Content 1 Start -->
<div class="bc-content section-1">
    <div class="row">
        <div class="col-6">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <input style="margin-top:11px; margin-left: 15px;" type="checkbox">
...
<div class="container-fluid p-5 section-3">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <img src="picture/Tarahjujur.svg" alt="">
        </div>
        <div class="col-2">
            <img src="picture/Local.svg" alt="">
        </div>
        <div class="col-2">
            <img src="picture/gerakan1000.svg" alt="">
        </div>
        <div class="col-2">
            <img src="picture/cimahi.svg" alt="">
        </div>
        <div class="col-2">
            <img src="picture/cubic.svg" alt="">
        </div>
    </div>
</div>
<!-- Content 3 End -->
...
<div class="container-fluid p-5 section-4">
    <div class="row">
        ...
        <div class="col-7">
            ...
            <h2 class="p2" style="margin-top:-20px"><b>Your Trainer</b></h2>
            <div class="row" style="padding-top:20px">
                <div class="col-1">
                </div>
                <div class="col-5">
                    <p style="color: var(--color-theme-0);">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                ...
                <div class="col-1">
                    <img style="padding-left:10px" src="picture/vektor-3.svg" alt="">
                </div>
                <div class="col-5">
                    <p style="color: var(--color-theme-0);">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                        dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h2 style="color: #FFFFFF; font-weight: bold;"><b>December 22nd 2020 at</b><br> Innovation Hub Space</h2>
                        ...
                        <a class="btn-solid-lg page-scroll" href="#register" style="border-radius: 20px; font-family: Modeco; color: #FFFFFF; margin-top: 80px; padding: 10px 20px 10px 20px; border: 1px solid #FFFFFF;">Read More</a>
